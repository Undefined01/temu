...
public final class Rv64BytecodeLanguage extends TruffleLanguage<Rv64Context> {
  ...
  @Option(help = "Enables common devices for GUI support", category = OptionCategory.USER,
          stability = OptionStability.STABLE)
  static final OptionKey<Boolean> gui = new OptionKey<>(false);

  @Option(help = "Maps a file to a memory region", category = OptionCategory.USER,
